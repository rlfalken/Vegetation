...
\end{equation} 
where $i$ denotes the vegetation species (1 for Bakers Blue Spruce, 2 for Blue Shag Eastern White Pine, and 3 for Gold Rider Leyland Cypress), and $j$ denotes the measurement. The sample size of the vegetation species is $n_{i}$. The $u_{ij}$ are the drag coefficient uncertainties. The parameter $m_{1}$ is the overall mean of the narrow leaves group and $\sigma$ is the between kind of vegetation species uncertainty. 
...
\end{equation} 
where $i$\,=\,4 for Distylium, $i$\,=\,5 for Fern, and $i$\,=\,6 for Red Holly). The parameter $m_{2}$ is the overall mean of the broad leaves group.
