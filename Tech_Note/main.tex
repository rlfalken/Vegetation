...
The uncertainty of the pressure measurement was determined by combining the precision uncertainty of the acquired data and the bias uncertainty of the pressure transducer. The uncertainty of the air density was calculated from uncertainty of the temperature and pressure measurements. Velocity uncertainty was established through the propagation of uncertainty that combined pressure and air density uncertainties. The drag coefficient uncertainty was also determined from the propagation of uncertainty, accounting for the pressure, air density and velocity uncertainties in addition to the absorption coefficient bias uncertainty.

\subsection{Determining the Volume of Vegetation via Water Displacement}
\label{ssec:headingscap}

The volume of the vegetation sample was measured after the wind tunnel measurement. The vegetation was separated into branches and leaves and put into cloth mesh bags of known mass and volume, weighed\footnote{The mass of the sample was used to estimate the density of the vegetation.}, and submerged in a bucket. The displaced water flowed through a spout and into a graduated cylinder (Fig.~\ref{fig:wdt}). The measurement was repeated three times for each sample. The volume ratio, $\beta$, was calculated by dividing the average sample volume by the volume it occupied (0.5~\si{m} $\times$ 0.5~\si{m} $\times$ 0.5~\si{m} = 0.125~\si{m^{3}}). The uncertainty of the volume ratio was established by combining via quadrature the uncertainty of the repeated measurements and the uncertainty of the graduated cylinder.
