...
\centering
	...
	\begin{tabular*}{\textwidth}{lcclcc}	
			\hline
\rule{0pt}{14pt}\textbf{Sample}	&\textbf{Cut}	& {\bf Branch/Leaf Volume}  \hspace{.2in}  &\textbf{Sample}			&	\textbf{Cut}	& {\bf Branch/Leaf Volume}	\\
\hline
\\[0.01cm]
Spruce		    	&	0		&   1.1			        		& Cypress       	&	0		&	1.5						\\
					&	1		& 	1.3							&					&	1		&	2.2						\\
					&	2		& 	1.5							&					&	2		&	3.0						\\
					&	3		&	N/A							&					&	3		&  	N/A 						\\
					&			&								&					&			&       							\\
Distylium			&	0		&	1.0							& Holly	     		&	0		&	11						\\
					&	1		&	1.4							&					&	1		&	16						\\
					&	2		&	3.3							&					&	2		&	47						\\
					&			&								&					&	3		&        N/A 						\\
\\[0.005cm]
