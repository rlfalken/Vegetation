...
The distribution of the measured drag coefficients for all sample configurations is shown in Fig.~\ref{fig:Histogram}. The collection of sample configurations is divided into two groups based on leaf shape (i.e., broad and narrow). The broad leaves group included the Evergreen Distylium, a Kimberly Queen Fern, and a Robin Red Holly while the narrow leaves group was comprised of the remaining species. The average drag coefficient of all sample configurations was determined to be 2.8 with an expanded uncertainty of 0.4. 

\begin{figure}[!]
	%\centering 	
\includegraphics[width=\textwidth,keepaspectratio]{Picture11.jpg}
	\caption[Distribution of drag coefficients for all samples (top), samples with broad leaves (bottom left), samples with narrow leaves (bottom right)]{Distribution of vegetation samples drag coefficients with noted mean and standard deviation values}
	\label{fig:Histogram}
\end{figure}
...
Further analysis was conducted to compare the two leaf shape groups. As shown in Fig.~\ref{fig:Histogram}, the broad leaves group appears to have lower drag coefficients compared to the narrow leaves group. The average drag coefficient of the broad leaves group was 2.5 with an expanded uncertainty of 0.2 while the narrow leaves group had an average of 3.1 with an expanded uncertainty of 0.2. In comparison, the two groups have significantly different means, with the average drag coefficient of the narrow leaves group being higher. However, the average drag coefficients of both groups are still within the uncertainty bound of the overall average drag coefficient suggesting that mean drag coefficient obtained from all samples could be a reasonable approximation when applied as a consistent drag coefficient for vegetation canopies in CFD models. 
...
\begin{enumerate}
  ...
  \item The overall average drag coefficient of the bulk vegetation was found to be 2.8 with an expanded uncertainty of 0.4. The differences between the average drag coefficients of different plant species and or leaves type groups were concluded to be non-significant suggesting that the overall average drag coefficient could be used as a constant value in CFD models of various plant types.
\end{enumerate}
